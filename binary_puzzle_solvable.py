"""
Solvable example of the Binary Puzzle Solver
"""
...
def main():
    print("Binary Puzzle Solver - Solvable Example")
    print("=====================================\n")
    
    # Create a 6x6 puzzle with minimal constraints but enough to be interesting
    ...
    # Initial board (6x6 grid) with strategic initial values
