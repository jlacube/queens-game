"""
Simple example of the Binary Puzzle Solver
"""
...
def main():
    print("Binary Puzzle Solver - Simple Example")
    print("===================================\n")
    
    # Create a 6x6 puzzle with minimal constraints and initial values
    ...
    # Initial board (6x6 grid) with just a few initial values
